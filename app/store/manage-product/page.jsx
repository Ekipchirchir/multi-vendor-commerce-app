...
export default function StoreManageProducts() {
    ...
    const fetchProducts = async () => {
        try{
            ...
            const { data } = await axios.get("/api/store/product", {headers: {Authorization: `Bearere ${token}`}})
    ...
    const toggleStock = async (productId) => {
        try{
            const token = await getToken()
            const { data } = await axios.post("/api/store/stock-toggle",{productId}, {headers: {Authorization: `Bearere ${token}`}})
